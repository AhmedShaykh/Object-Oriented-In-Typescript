...
hum.eat();
let r0 = new Animal("Donkey"); // In This Method Class Type Check Object Same Property & Method Than Accept It!
...
myCar.startEngine();
class Motorcycle {
    make = "Harley Davidson"; // Abstraction Implementions Hide Then Assign Child Class
    model;
}
;
